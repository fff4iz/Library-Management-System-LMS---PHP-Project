            ...
            <tbody>
                ...
                if (isset($_GET['book_id'])) {
                    ...
                    while($row = mysqli_fetch_assoc($view_book))
                    {
                        ...
                        echo "<td><a href='admin-borrow-book.php?book_id={$row['id']}' class='btn btn-primary'>Borrow</a></td>";
                        echo "<td><a href='admin-return-book.php?book_id={$row['id']}' class='btn btn-secondary'>Return</a></td>";
                        echo "</tr>";
                    }
                }
                ?>
